...
class TestAuditHistory(SeleniumTest):
    ...
    _AUDIT_DATA = {
        ...
        'module_provider_create': ['test-event-admin', AuditAction.NAMESPACE_CREATE, 'Namespace', 'test-namespace', None, None,
                 datetime(year=2020, month=11, day=27, hour=19, minute=14, second=10)],
        'module_version_index_1': ['namespaceowner', AuditAction.MODULE_VERSION_INDEX, 'Module', 'test-namespace/test-module/2.0.1', None, None,
                 datetime(year=2021, month=12, day=28, hour=19, minute=16, second=23)],
        'module_version_index_2': ['namespaceowner', AuditAction.MODULE_VERSION_INDEX, 'Module', 'test-namespace/test-module/2.0.1', None, None,
                 datetime(year=2021, month=12, day=28, hour=19, minute=15, second=10)],
        'module_version_publish': ['namespaceowner', AuditAction.MODULE_VERSION_PUBLISH, 'Module', 'test-namespace/test-module/2.0.1', None, None,
                 datetime(year=2021, month=12, day=29, hour=19, minute=23, second=31)],
        'module_version_delete': ['namespaceowner', AuditAction.MODULE_VERSION_DELETE, 'Module', 'test-namespace/test-module/2.0.1', None, None,
                 datetime(year=2021, month=12, day=29, hour=20, minute=12, second=23)],
        'user_login_1': ['testuser1', AuditAction.USER_LOGIN, 'User', 'testuser1', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=49, second=20)],
        'user_login_2': ['testuser2', AuditAction.USER_LOGIN, 'User', 'testuser2', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=50, second=20)],
        'user_login_3': ['testuser3', AuditAction.USER_LOGIN, 'User', 'testuser4', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=52, second=20)],
        'user_login_4': ['testuser4', AuditAction.USER_LOGIN, 'User', 'testuser4', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=53, second=20)],
        'user_login_5': ['testuser5', AuditAction.USER_LOGIN, 'User', 'testuser5', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=54, second=20)],
        'user_login_6': ['testuser6', AuditAction.USER_LOGIN, 'User', 'testuser6', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=55, second=20)],
        'user_login_7': ['testuser7', AuditAction.USER_LOGIN, 'User', 'testuser7', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=56, second=20)],
        'user_login_8': ['testuser8', AuditAction.USER_LOGIN, 'User', 'testuser8', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=57, second=20)],
        'user_login_9': ['testuser9', AuditAction.USER_LOGIN, 'User', 'testuser9', None, None,
                 datetime(year=2020, month=1, day=2, hour=9, minute=58, second=20)],
        'user_login_10': ['testuser10', AuditAction.USER_LOGIN, 'User', 'testuser10', None, None,
    ...
    def _ensure_audit_row_is_like(self, row, audit_item):
    ...
    def test_column_ordering(self):
        ...
        column_headers = [r for r in audit_table.find_elements(By.TAG_NAME, 'th')]
        for column_itx, expected_rows in [
            ...
            (2, [self._AUDIT_DATA['user_login_1'], self._AUDIT_DATA['user_login_2']]),

            # Sort by object
            (3, [None, self._AUDIT_DATA['namespace_create']]),
            # Sort by object reversed
            (3, [self._AUDIT_DATA['user_login_9'], self._AUDIT_DATA['user_login_8']])
        ]:
