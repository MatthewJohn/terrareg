...
class TestProvider(TerraregIntegrationTest):
    ...
    def test_refresh_versions_with_limit(self, mock_provider_source_class, test_provider, test_gpg_key, test_namespace):
        ...
        try:
            with unittest.mock.patch(
                ...
                created_versions = test_provider.refresh_versions(limit=1)
    ...
    def test_refresh_versions_with_version(self, mock_provider_source_class, test_provider, test_gpg_key, test_namespace):
        """Test refresh_versions method with version"""
        try:
            with unittest.mock.patch(
                        'terrareg.provider_extractor.ProviderExtractor.obtain_gpg_key',
                        unittest.mock.MagicMock(return_value=test_gpg_key)) as mock_obtain_gpg_key, \
                ...
                created_versions = test_provider.refresh_versions(version="1.5.0")
    ...
    def test_refresh_versions_with_version_not_found(self, mock_provider_source_class, test_provider, test_gpg_key, test_namespace):
        ...
        try:
            with unittest.mock.patch(
                ...
                created_versions = test_provider.refresh_versions(version="2.3.0")

                mock_obtain_gpg_key.assert_not_called()
