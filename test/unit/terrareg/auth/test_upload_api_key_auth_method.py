...
from terrareg.auth import UploadApiKeyAuthMethod, UserGroupNamespacePermissionType
from test.unit.terrareg.auth.base_auth_method_test import BaseAuthMethodTest
from test import BaseTest


class TestUploadApiKeyAuthMethod(BaseAuthMethodTest):
    """Test methods of UploadApiKeyAuthMethod auth method"""
    ...
    def test_is_enabled(self, upload_api_keys, expected_result):
    ...
    def test_check_auth_state(self, api_key_config, api_key_header, expected_result):
        ...
        with mock.patch('terrareg.config.Config.UPLOAD_API_KEYS', api_key_config), \
