...
from test.unit.terrareg import (
    TerraregUnitTest, mock_server_user_groups_fixture, setup_test_data,
    MockUserGroup, MockUserGroupNamespacePermission, MockNamespace
)
...
class TestApiTerraregIsAuthenticated(TerraregUnitTest):
    ...
    def test_authenticated_site_admin(self, client, mock_server_user_groups_fixture):
    ...
    def test_authenticated_with_permissions(self, client, mock_server_user_groups_fixture):
        ...
        mock_auth_method.get_all_namespace_permissions.return_value = {
            MockNamespace('testnamespace'): UserGroupNamespacePermissionType.FULL
        }
    ...
    def test_unauthenticated(self, client, mock_server_user_groups_fixture):
        """Test endpoint when user is authenticated."""
