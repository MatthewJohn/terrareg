...
def downgrade():
    ...
    with op.batch_alter_table('analytics', schema=None, naming_convention=naming_convention) as batch_op:
        ...
        batch_op.create_foreign_key('fk_analytics_parent_module_version_module_version_id', 'module_version', ['parent_module_version'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
    # ### end Alembic commands ###
