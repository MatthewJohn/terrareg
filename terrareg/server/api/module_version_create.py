...
class ApiModuleVersionCreate(ErrorCatchingResource):
    ...
    def _post(self, namespace, name, provider, version):
        ...
        parser.add_argument(
            ...
            required=False,
            default=None,
            help='Request ID, generated by client, to identify extraction to obtain status messages.',
            location='json'
        )
        ...
        with terrareg.module_extractor.GitModuleExtractor(module_version=module_version, request_id=args.request_id) as me:
            me.process_upload()
