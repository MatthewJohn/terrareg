...
For information about running with docker-compose, SSL certificate generation or running without docker, see [LOCAL_DEVELOPMENT.md](./LOCAL_DEVELOPMENT.md).
...
For information about setting up Single Sign-on, please see [SSO.md](./SSO.md)
